...
def get_results_dict() -> dict:
    res_dict = {
        "case_color": [
            40.20318213, 35.35496166, 31.02521989, 29.54828771, 27.14293436, 27.09203161, 26.40146892, 23.90050957,
            23.23194967, 22.82641386
        ],
        "case_still_haven_v2": [54.18586341, 47.75698969, 43.20926884, 36.57481208, 29.19424202],
        "case_still_haven": [50.44628744, 48.09125223, 47.50439963, 42.09104433, 37.28185969],
        "case_still_v2": [56.66434772, 51.39635758, 45.88279167, 38.80435224, 33.65569984],
        "case_front3d_cc2": [57.1682762, 56.02389439, 55.87552494, 54.80240991, 52.3356436],
        "case_front3d_cc_a": [41.74083515, 41.72880772, 41.22474582, 39.54968345, 33.88822593],
        "case_front3d_cc": [48.0064636, 47.67540795, 47.51297498, 47.31211337, 46.50091182],
        "case_front3d_dust_smear": [57.85217024, 56.10571592, 55.71833497, 55.25355756, 54.12277924],
        "case_front3d_light": [53.04325583, 52.43420533, 50.29381193, 46.75026469, 44.47449601],
        "case_front3d_haven": [61.96609497, 58.79461317, 55.62541417, 50.06178549, 49.31000245],
        "case_front3d_b": [64.04062038, 57.96809713, 57.21279704, 54.31943874, 50.49968236],
        "case_front3d_a": [62.8612593, 60.40714259, 50.52970971, 50.20810414, 47.52600713],
        "case_front3d_v2": [61.01553947, 55.58437218, 49.60603806, 49.53397071, 46.5568013],
        "case_front3d": [62.02147473, 53.78759735, 53.63398144, 44.57640408, 41.05447549],
        "case_better_color": [52.97515493, 48.77915566, 47.3969108, 46.21510695, 37.15266009],
        "case_suncg_still": [53.24553563, 49.94363528, 47.32345091, 40.10024404, 34.41072612],
        "case_better_still": [51.00154199, 43.314532, 42.72145512, 42.58400301, 35.25105671],
        ...
        "case_best_off": [38.27442956, 36.98222766, 33.18468101, 32.26386027, 30.13600164],
        "case_green": [42.07711803, 33.84280772, 33.08787521, 31.47131132, 30.18678932],
        "case_white": [21.0838, 17.2644, 12.5009, 11.3386, 6.06284],
        "case_flat": [37.91878455, 30.64923742, 28.30067853, 27.75824945, 27.34716009],
        "case_smooth": [30.82600167, 30.42064908, 27.06868854, 25.34457596, 20.87147743],
        "case_refined": [22.3332, 21.3385, 21.0649, 18.4229, 14.5228],
        "case_cam_k": [29.96887896, 26.99492782, 22.50186606, 16.9611616, 15.7358362],
        ...
        "case_2048_samples": [25.51789534, 23.77423735, 22.73706366, 22.58643221, 20.10152691],
        "case_color_texture": [42.27489632, 33.6542957, 32.44540635, 30.33389404, 20.45308856],
        "case_texture": [30.93216935, 30.5514081, 28.04813986, 24.42527646, 19.33343886],
        "case_more_bounces": [33.83921761, 29.46399028, 27.03319279, 26.84496801, 25.03445091],
        "case_area_light": [28.64929296, 26.14490815, 21.8578116, 19.71479663, 17.28886026],
        "case_cam_uniform3d_inplane": [31.96673795, 31.26197291, 30.49044743, 24.15643791, 23.57493626],
        "case_cam_uniform3d": [26.97584852, 26.62969497, 26.14628782, 21.09606741, 20.16900372],
        "case_cam_poi": [10.86430437, 7.79265517, 7.42004987, 6.64692292, 6.02255621],
        "case_white_light": [31.87034131, 29.22695543, 26.59384891, 23.18313712, 20.93746476],
        "case_no_bounces": [32.4185546, 28.64617559, 25.05437995, 23.88907582, 19.67199348],
        "case_uniform_clutter": [33.40435191, 31.27687028, 26.87701708, 25.97052168, 23.90796012],
        "case_clutter": [36.49185575, 30.14689522, 25.91438832, 25.32848971, 20.45497139],
        "case_high_res": [32.10037995, 27.17417729, 17.91426037, 14.40626157, 12.24492306],
        "case_point_lights_only": [27.49361244, 25.31737831, 21.3253789, 14.1208087, 11.48722047],
        "case_less_light": [26.20951466, 23.10560782, 21.613864, 20.07971469, 4.9723414],
        "case_two_lights": [26.07114511, 19.92342411, 11.68455528, 9.60110245, 3.3309312],
        "case_even_less_cam_rotation": [41.14436033, 37.58032475, 35.9072579, 34.13007927, 30.49871135],
        "case_fov": [36.76167819, 35.08760321, 31.27037743, 30.37089514, 26.70382605],
        "case_less_cam_rotation": [25.7747, 18.8846, 18.2181, 17.4002, 10.1219],
        "case_train_green": [36.01153481, 34.57256129, 31.54693327, 30.22182292, 22.28776532],
        "case_test_green": [27.6192, 21.9087, 21.3022, 20.4311, 17.6845],
        "case_no_specular": [19.30362239, 18.9428661, 17.37443433, 13.01278383, 11.54669053],
        "case_no_denoiser": [30.0072, 27.3804, 25.6204, 22.7732, 19.3679],
        "case_no_glossy": [35.6989, 29.8466, 29.3413, 25.6552, 17.015],
        "case_no_rough": [35.69471537, 33.93573952, 30.49634283, 30.43674663, 24.45885994],
        "case_no_point_light": [40.83368553, 34.71397511, 32.09706752, 27.477971, 25.45296477]
    }
    return res_dict
...
def get_space() -> list:
    space = [
        ...
        skopt.space.Categorical(np.arange(0.0, 1.1, 0.1), name="motion_blur"),
        skopt.space.Categorical(np.arange(0.0, 1.1, 0.1), name="cutout"),
        skopt.space.Categorical([10, 50, 100, 200], name="cutout_sizes"),
        skopt.space.Categorical(np.arange(0.0, 1.1, 0.1), name="sharpen"),
        skopt.space.Categorical(np.arange(0.0, 1.1, 0.1), name="clahe"),
        skopt.space.Categorical(np.arange(0.0, 1.1, 0.1), name="channel_dropout"),
        skopt.space.Categorical(np.arange(0.0, 1.1, 0.1), name="invert"),
        skopt.space.Categorical(np.arange(0.0, 1.1, 0.1), name="hist"),
        skopt.space.Categorical([True, False], name="vignette"),
        skopt.space.Categorical([True, False], name="chromatic"),
        # skopt.space.Categorical([True, False], name="aae"),
        skopt.space.Categorical(np.arange(0.0, 1.1, 0.1), name="warmup_fraction"),
    ...
    if "reduce_lr" in values:
        if values["reduce_lr"] != 0.0:
            if values["reduce_lr"] == 0.1:
                ...
                cfg.SOLVER.STEPS = [
                    int(fraction * cfg.SOLVER.MAX_ITER) for fraction in np.arange(start_step, 1, start_step)
                ]
    ...
    if "cutout" in values:
        if values["cutout"] <= 1.0:
            ...
            if "cutout_sizes" in values:
                cfg.CUTOUT_SIZES = [values["cutout_sizes"], values["cutout_sizes"], None, None] if cfg.CUTOUT else []
